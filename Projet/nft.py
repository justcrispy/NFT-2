...
for x in range(int(A)): #permet de répéter la boucle le nombre de fois que l'on a choisi dans A
    ...
    file = "C:/Users/quent/OneDrive/Bureau/Projet/Projet/background/%s.png" % X # récupère les images background
    background = Image.open(file)

    file = "C:/Users/quent/OneDrive/Bureau/Projet/Projet/forme_visage/%s.png" % Y # récupère les formes du visage
    visage = Image.open(file)

    file = "C:/Users/quent/OneDrive/Bureau/Projet/Projet/couleur_visage_rond/%s.png" % Q # récupère les couleurs du visage rond
    couleur_visage_rond = Image.open(file)

    file = "C:/Users/quent/OneDrive/Bureau/Projet/Projet/couleur_visage_carré/%s.png" % Q # récupère les couleurs du visage carré
    couleur_visage_carré = Image.open(file)

    file = "C:/Users/quent/OneDrive/Bureau/Projet/Projet/coiffure_homme_rond/%s.png" % Z # récupère les coiffures homme
    coiffure = Image.open(file)

    file = "C:/Users/quent/OneDrive/Bureau/Projet/Projet/yeux/%s.png" % W # récupère les yeux
    yeux = Image.open(file)
    yeux_size = yeux.size
    yeux = yeux.resize((int(yeux_size[0]/3.0),int(yeux_size[1]/3.0)),Image.ANTIALIAS)

    file = "C:/Users/quent/OneDrive/Bureau/Projet/Projet/corps_homme_couleur_3/%s.png" % C # récupère les vêtements haut du corp
    corp = Image.open(file)
    corp_size = corp.size
    corp = corp.resize((int(corp_size[0]/3.0),int(corp_size[1]/3.0)),Image.ANTIALIAS)

    file = "C:/Users/quent/OneDrive/Bureau/Projet/Projet/bouche/%s.png" % V #récupère la bouvhe
    ...
    file = "C:/Users/quent/OneDrive/Bureau/Projet/Projet/sourcil/%s.png" % S # récupère les sourcil
